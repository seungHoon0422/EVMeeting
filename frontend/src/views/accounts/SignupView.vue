    ...
    <div class="mt-5 p-3 mb-5 rounded form-style">
      ...
      <form @submit.prevent="signup(credentials)" class="mt-5">
        <div class="d-flex justify-content-between">
          <div class="ms-3">
            ...
            <div class="mt-3 d-flex justify-content-end">
              ...
              <input id="height" v-model="credentials.height" class="input-color rounded length height p-3" type="number" placeholder="키" required>
            </div>
            <div class="mt-3 d-flex justify-content-end">
              <label for="weight" class="me-3 pt-3">몸무게</label>
              <input id="weight" v-model="credentials.weight" class="input-color rounded length height p-3" type="number" placeholder="몸무게" required>
            </div>
            <div class="mt-3 d-flex justify-content-end">
          ...
          <div class="me-5">
            <div class="d-flex justify-content-end">
              ...
              <input id="username" v-model="credentials.username" class="input-color rounded length height p-3" type="text" placeholder="닉네임" required>
            </div>
            <div class="mt-3 d-flex justify-content-end">
            ...
            <div class="mt-3 d-flex justify-content-end">
              ...
              <input id="hobby" v-model="credentials.hobby" class="input-color rounded length height p-3" type="text"  placeholder="관심사(모달창띄우기)" required>
            </div>
            <div class="mt-3 d-flex justify-content-end">
              <label for="school" class="me-3 pt-3">학교</label>
              <input id="school" v-model="credentials.school" class="input-color rounded length height p-3" type="text" placeholder="학교" required>
            </div>
            <div class="mt-3 d-flex justify-content-end">
        ...
        <div class="mt-3">
          ...
          <textarea v-model="credentials.description" name="self-intro" id="" cols="80" rows="5" class="input-color" required></textarea>
        </div>
